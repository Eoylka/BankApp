...
//1. add event listener to common parent listener
...
// // header.prepend(message); // firstchild
...
// logo.setAttribute('company', 'Bankist'); //создать атрибут кампани с названием банкист

// // non standart
// console.log(logo.getAttribute('designer')); // поиск по атрибуту внутри элемента
...
//   alert('addEventListener: Greate! You are reading the headind :D');
